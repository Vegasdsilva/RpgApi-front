...
namespace RpgMvc.Controllers
{
    ...
    {
        public string uriBase = "http://ericksonvegas.somee.com/RpgApi/Usuarios/";
        //xyz tem ser substituido pelo endereço da sua API
    ...
    [HttpPost]
    public async Task<ActionResult> RegistrarAsyng(UsuarioViewModel u)
    {
        try
        {
